...
- **Registry**: `rohitmlregistry.azurecr.io`
...
jobs:
  build-and-deploy:
    ...
    - name: 'Login to Azure Container Registry'
      ...
      with:
        login-server: rohitmlregistry.azurecr.io
        username: ${{ secrets.AZURE_REGISTRY_USERNAME }}
        password: ${{ secrets.AZURE_REGISTRY_PASSWORD }}

    - name: 'Build and push Docker image'
      run: |
        docker build . -t rohitmlregistry.azurecr.io/studentperformance:${{ github.sha }}
        docker build . -t rohitmlregistry.azurecr.io/studentperformance:latest
        docker push rohitmlregistry.azurecr.io/studentperformance:${{ github.sha }}
        docker push rohitmlregistry.azurecr.io/studentperformance:latest
    ...
    - name: 'Deploy to Azure App Service'
      ...
      with:
        ...
        images: 'rohitmlregistry.azurecr.io/studentperformance:latest'
```
...
- `DOCKER_REGISTRY_SERVER_URL`: `rohitmlregistry.azurecr.io`
...
docker login rohitmlregistry.azurecr.io
...
az webapp config container set \
  ...
  --docker-custom-image-name rohitmlregistry.azurecr.io/studentperformance:latest
```
...
./config.sh --url https://github.com/RohitNaikCodes/studentperformance --token YOUR_TOKEN
./run.sh
...
[![Email](https://img.shields.io/badge/Email-jitesh.kumar05official%40gmail.com-red?style=for-the-badge&logo=gmail&logoColor=white)](mailto:rohit.naik@example.com)

[![LinkedIn](https://img.shields.io/badge/LinkedIn-Jitesh%20Kumar-blue?style=for-the-badge&logo=linkedin&logoColor=white)](https://www.linkedin.com/in/rohitnaikcodes/)

[![GitHub](https://img.shields.io/badge/GitHub-RohitNaikCodes-black?style=for-the-badge&logo=github&logoColor=white)](https://github.com/RohitNaikCodes)
...
[![GitHub stars](https://img.shields.io/github/stars/RohitNaikCodes/studentperformance?style=social)](https://github.com/RohitNaikCodes/studentperformance)
[![GitHub forks](https://img.shields.io/github/forks/RohitNaikCodes/studentperformance?style=social)](https://github.com/RohitNaikCodes/studentperformance)
